    ...
    return (
        <section className="brands">
            <div className="brands__container">
                <h2 className="brands__title">Our Brands</h2>
                <p className="brands__subtitle">Small Shoes 2017 new Arrivals  mini Messenger 
                    <a href="#" className="brands__link">Classic Shoes</a>
                </p>
                <p className="brands__text">In porttitor elit ac mi placerat hendrerit. 
